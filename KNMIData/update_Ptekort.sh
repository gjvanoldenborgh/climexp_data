...
# Global radiation is derived from sunshine dutaion 1906-1958, observed at De Bilt afterwards
# Precipitation is the <a href="https://climexp.knmi.nl/getindices.cgi?KNMIData/precip13stations">P13 series</a>, validated but non-homogenised.
