...
# Maue's ACE series
#
wget -q -N http://policlimate.com/tropical/global_ace.dat
...
# source :: <a href="http://policlimate.com/tropical/">wx.graphics</a>
# source_url :: http://policlimate.com/tropical/global_ace.dat
